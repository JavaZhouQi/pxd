package com.pxd.comon.db.generator;
...
public class MybatisPlusGenerator {
    ...
    public static void main(String[] args) {
        FastAutoGenerator.create("jdbc:mysql://nginx.pixiaodan.cn:3306/pxd_user", "root", "root")
                .globalConfig(builder -> {
                    builder.author("PiXiaoDan") // 设置作者
                            .enableSwagger() // 开启 swagger 模式
                            .fileOverride() // 覆盖已生成文件
                            .outputDir("D:\\Project\\open\\pxd\\pxd-modules\\pxd-user\\pxd-user-service/src/main/java"); // 指定输出目录
                })
                .packageConfig(builder -> {
                    builder.parent("com.pxd") // 设置父包名
                ...
                .strategyConfig(builder -> {
                    builder
                            .addInclude("sys_route", "sys_user_route") // 设置需要生成的表名
